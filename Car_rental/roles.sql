...
-- DJANGO STUFF:
grant select,update on outlet,customer_customer_id_seq ,employee_employee_id_seq,employee_employee_id_seq,outlet_outlet_id_seq,rent_bill_id_seq to employee_role;
grant select,update on outlet,customer_customer_id_seq ,employee_employee_id_seq,employee_employee_id_seq,outlet_outlet_id_seq,rent_bill_id_seq,reservation_reservation_id_seq to customer_role;