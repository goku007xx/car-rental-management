...
INSERT into vehicle values('DA-12-2192','omni',6,TRUE,'not-taken',500,1),('KA-18-1221','swift',5,TRUE,'not-taken',1000,2),('DW-12-2192','omni',6,TRUE,'not-taken',1500,1),('KA-18-1220','fastest',10,TRUE,'not-taken',2500,2);
